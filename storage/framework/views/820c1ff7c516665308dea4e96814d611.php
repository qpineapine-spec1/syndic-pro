...
<?php $__env->startSection('title', 'Syndic Professionnel'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="hero-grid">
                    <div class="hero-copy">
                        ...
                        <div class="welcome-cta">
                            <a href="<?php echo e(route('register')); ?>" class="btn-primary">S'inscrire</a>
                            <a href="<?php echo e(route('login')); ?>" class="btn-secondary">Se connecter</a>
                            <a href="<?php echo e(route('templates.modele-premiere-assemblee')); ?>" class="btn-secondary">Télécharger le modèle de 1ère assemblée</a>
                        </div>
                    </div>
                    <div class="hero-visual">
                        <img src="<?php echo e(asset('images/image1.jpeg')); ?>" alt="Logo" />
                    </div>
                </div>
            </section>
            ...
            <section class="reglement-section">
                <div class="card-glass reglement-card">
                    ...
                    <?php if(!empty($reglement) && $reglement->reglement_fichier): ?>
                        <a href="<?php echo e(route('properties.reglement.download', $reglement)); ?>" class="btn-secondary">Télécharger le règlement</a>
                    <?php else: ?>
