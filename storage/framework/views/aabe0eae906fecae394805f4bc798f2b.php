...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Syndic Professionnel'); ?></title>
...
<body class="page-fade-in">
    <header class="card-glass" style="position:sticky; top:0; z-index:10; margin:1.2rem auto 0; width:min(var(--container), calc(100vw - 48px)); border-radius:18px; padding:1rem 1.2rem;">
        <div style="display:flex; justify-content:space-between; align-items:center; gap:1rem; flex-wrap:wrap;">
            <a href="<?php echo e(route('dashboard')); ?>" style="font-weight:800; color:var(--color-primary);">Syndic Professionnel</a>
            <div class="header-actions">
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->role === 'copropriétaire' && auth()->user()->owner?->is_council_member): ?>
                        <span class="feature-badge" style="margin-top:0;">Conseil syndical</span>
                    <?php endif; ?>
                <?php endif; ?>
                <?php if (! (request()->is('/'))): ?><?php echo view('components.notification-dropdown')->render() . view('components.message-dropdown')->render(); ?><?php endif; ?>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('logout')); ?>" class="btn-secondary" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        Déconnexion
                    </a>
            ...
            <div class="app-shell">
                <aside class="app-sidebar card-glass" id="app-sidebar">
                    ...
                    <nav class="sidebar-nav" aria-label="Fonctionnalités de l'espace">
                        ...
                        ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'is-active' : ''); ?>" data-tooltip="Tableau de bord">
                        ...
                        <?php if(auth()->user()->role === 'syndic'): ?>
                            <a href="<?php echo e(route('import.upload')); ?>" class="sidebar-link <?php echo e(request()->routeIs('import.*') ? 'is-active' : ''); ?>" data-tooltip="Importer le PDF de 1ère assemblée">
                            ...
                            <a href="<?php echo e(route('owners.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('owners.*') ? 'is-active' : ''); ?>" data-tooltip="Gestion des copropriétaires">
                            ...
                            <a href="<?php echo e(route('contributions.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('contributions.*') ? 'is-active' : ''); ?>" data-tooltip="Cotisations">
                            ...
                            <?php if($hasFirstAssembly): ?>
                                <a href="<?php echo e(route('expenses.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('expenses.*') ? 'is-active' : ''); ?>" data-tooltip="Dépenses">
                            ...
                            <?php if($hasFirstAssembly): ?>
                                <a href="<?php echo e(route('complaints.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('complaints.*') ? 'is-active' : ''); ?>" data-tooltip="Réclamations">
                            ...
                            <?php if($hasFirstAssembly): ?>
                                <a href="<?php echo e(route('meetings.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('meetings.*') ? 'is-active' : ''); ?>" data-tooltip="Réunions &amp; votes">
                            ...
                            <?php if($hasFirstAssembly): ?>
                                <a href="<?php echo e(route('messages.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('messages.*') ? 'is-active' : ''); ?>" data-tooltip="Messagerie">
                            ...
                            <?php if($hasFirstAssembly): ?>
                                <a href="<?php echo e(route('tenants.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('tenants.*') ? 'is-active' : ''); ?>" data-tooltip="Gestion locataires">
                            ...
                            <?php if($syndicProperty?->reglement_fichier): ?>
                                <a href="<?php echo e(route('properties.reglement.download', $syndicProperty)); ?>" class="sidebar-link <?php echo e(request()->routeIs('properties.reglement.*') ? 'is-active' : ''); ?>" data-tooltip="Règlement de copropriété">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('properties.reglement.form', $syndicProperty)); ?>" class="sidebar-link <?php echo e(request()->routeIs('properties.reglement.*') ? 'is-active' : ''); ?>" data-tooltip="Téléverser le règlement de copropriété">
                                    <span class="sidebar-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M3 12h18"/><path d="M12 3v18"/><path d="M4 4l16 16"/><path d="M20 4L4 20"/></svg></span>
                                    <span class="sidebar-label">Règlement de copropriété<small>À téléverser</small></span>
                                </a>
                            <?php endif; ?>
                        <?php elseif(auth()->user()->role === 'copropriétaire'): ?>
                            <a href="<?php echo e(route('profile.show')); ?>" class="sidebar-link <?php echo e(request()->routeIs('profile.*') ? 'is-active' : ''); ?>" data-tooltip="Infos personnelles">
                            ...
                            <?php if($ownerHasContribution): ?>
                                <a href="<?php echo e(route('contributions.owner')); ?>" class="sidebar-link <?php echo e(request()->routeIs('contributions.owner') ? 'is-active' : ''); ?>" data-tooltip="Ma cotisation">
                                    <span class="sidebar-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M12 2v20"/><path d="M2 12h20"/><path d="M4 4h16v16H4z" opacity="0.2"/></svg></span>
                            ...
                            <?php if($currentUser->owner?->is_council_member): ?>
                                <a href="<?php echo e(route('expenses.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('expenses.*') ? 'is-active' : ''); ?>" data-tooltip="Dépenses">
                                    <span class="sidebar-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M4 7h16"/><path d="M7 7v10"/><path d="M17 7v10"/><path d="M4 17h16"/><path d="M4 4h16v16H4z"/></svg></span>
                                    <span class="sidebar-label">Dépenses</span>
                                </a>
                            ...
                            <a href="<?php echo e(route('tenants.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('tenants.*') ? 'is-active' : ''); ?>" data-tooltip="Locataire de mon bureau">
                                <span class="sidebar-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M3 12h18"/><path d="M5 12V6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v6"/><path d="M7 12v8h10v-8"/></svg></span>
                                <span class="sidebar-label">Locataire de mon bureau</span>
                            </a>

                            <?php if($ownerReglementProperty?->reglement_fichier): ?>
                                <a href="<?php echo e(route('properties.reglement.download', $ownerReglementProperty)); ?>" class="sidebar-link <?php echo e(request()->routeIs('properties.reglement.*') ? 'is-active' : ''); ?>" data-tooltip="Règlement de copropriété">
                                    <span class="sidebar-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" aria-hidden="true"><path d="M3 12h18"/><path d="M12 3v18"/><path d="M4 4l16 16"/><path d="M20 4L4 20"/></svg></span>
                                    <span class="sidebar-label">Règlement de copropriété</span>
                                </a>
                            <?php else: ?>
...
</html><?php /**PATH C:\Users\Hp\Desktop\Project-syndic\nouveau-projet\resources\views/layouts/app.blade.php ENDPATH**/ ?>